...
const styles = StyleSheet.create({
  ...
  ratingLabel: { fontSize: FontSize.xs, fontWeight: FontWeight.bold, color: 'rgba(255,255,255,0.62)', letterSpacing: 1, marginBottom: 4 },
  ...
  scoreMax: { fontSize: FontSize.md, color: 'rgba(255,255,255,0.62)', marginBottom: 4 },
  voteCount: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.62)', marginTop: 4 },
